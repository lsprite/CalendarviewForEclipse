...
public class MonthViewPager extends ViewPager {
	...
	private void init() {
		mMonthCount = 12 * (mDelegate.getMaxYear() - mDelegate.getMinYear()) - mDelegate.getMinYearMonth() + 1
		...
		setOnPageChangeListener(new ViewPager.OnPageChangeListener() {
			...
			public void onPageSelected(int position) {
				...
				if (mDelegate.mDateSelectedListener != null) {
					...
					mDelegate.mDateSelectedListener.onDateSelected(mDelegate.mSelectedCalendar, calendar, false);
				}
