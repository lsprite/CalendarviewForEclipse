...
public class SimpleActivity extends Activity
		implements CalendarView.OnDateSelectedListener, CalendarView.OnYearChangeListener, View.OnClickListener {
	...
	protected void initData() {
		...
		schemes.add(getSchemeCalendar(year, month, 31, 0xFFfeaa00, ""));
		/*
	...
	public void onClick(View v) {
		switch (v.getId()) {
		/*
		 * case R.id.ll_flyme: MeiZuActivity.show(this); break; case
		 * R.id.ll_simple: SimpleActivity.show(this); break; case
		 * R.id.ll_colorful: ColorfulActivity.show(this); break; case
		 * R.id.ll_index: IndexActivity.show(this); break;
		 */
		}
	}
	...
	@Override
	public void onDateSelected(Calendar calendar, Calendar showCalendar, boolean isClick) {
		// TODO Auto-generated method stub
		mTextLunar.setVisibility(View.VISIBLE);
		mTextYear.setVisibility(View.VISIBLE);
		mTextMonthDay.setText(showCalendar.getMonth() + "月" + showCalendar.getDay() + "日");
		mTextYear.setText(String.valueOf(showCalendar.getYear()));
		mTextLunar.setText(showCalendar.getLunar());
		mYear = showCalendar.getYear();
	}
